...
def load_dataset(args, training_num=None, use_fixed_validation=False, no_binarization=False, **kwargs):
    ...
    elif args.dataset_name == 'tabular_timeseries':
        from .timeseries_loader import tabular_timeseries_loader
        args.training_set_size = 0  # placeholder; overridden inside load_dataset()
        train_loader, val_loader, test_loader, args = tabular_timeseries_loader(args).load_dataset(**kwargs)
    else:
